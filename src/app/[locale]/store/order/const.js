...
export const foreignPay = function ({ CONFIG, LANG }) {
  return [
    ...
    //   key: "creditCard",
    //   imgList: [
    //     `${process.env.NEXT_PUBLIC_IMAGE}/icon/pay-visa.png`,
    //     `${process.env.NEXT_PUBLIC_IMAGE}/icon/pay-master.png`,
    //     `${process.env.NEXT_PUBLIC_IMAGE}/icon/pay-maestro.png`,
    //     `${process.env.NEXT_PUBLIC_IMAGE}/icon/pay-american-express.png`,
    //     `${process.env.NEXT_PUBLIC_IMAGE}/icon/pay-diners-clubs.png`,
    //     `${process.env.NEXT_PUBLIC_IMAGE}/icon/pay-discover.png`,
    //     `${process.env.NEXT_PUBLIC_IMAGE}/icon/pay-jcb.png`,
